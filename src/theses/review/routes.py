...
bp.add_url_rule("/review/index.html", methods=["GET"], view_func=thesis_review_index)


@bp.route("/review/submit", methods=["GET", "POST"])
@login_required
def submit_thesis_on_review():
    ...
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            return redirect(url_for("theses.thesis_review_index"))
        else:
...
@bp.route("/review/edit", methods=["GET", "POST"])
@login_required
...
@bp.route("/review/delete", methods=["GET"])
...
@bp.route("/review/review", methods=["GET"])
@login_required
...
@bp.route("/review/reviewed", methods=["GET", "POST"])
@login_required
...
@bp.route("/review/review_result", methods=["GET"])
@login_required
...
@bp.route("/review/fetch_thesis_on_review", methods=["GET"])
...
@bp.route("/review/become_thesis_reviewer", methods=["GET"])
@login_required
...
@bp.route("/review/become_thesis_reviewer_confirm", methods=["GET"])
@login_required
