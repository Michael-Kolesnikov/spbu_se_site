from src.internships import bp
from flask import render_template, request, flash, redirect, url_for
from src.internships.forms import InternshipsFilter, AddInternship
from src.models import Internships, InternshipCompany, InternshipFormat, InternshipTag
from src.extensions import db


@bp.route("/internships/internships_index.html", methods=["GET"])
...
# @login_required
@bp.route("/internships/add_internship.html", methods=["GET", "POST"])
def add_internship():
    user = ()
    # user = current_user
...
@bp.route("/internships/fetch_internships", methods=["GET"])
...
@bp.route("/internships/index", methods=["GET"])
def old_internships_index():
    return redirect(url_for("internships.internships_index"))


@bp.route("/internships/<int:id>", methods=["GET", "POST"])
...
@bp.route("/internships/<int:id>/update", methods=["GET", "POST"])
